...
export default function AreaMantencion() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      ...
      <h1 className="text-4xl font-bold text-neb-black dark:text-white mb-6">Área de Mantención</h1>
      ...
      <ul className="space-y-4 mb-10">
        {[
          'Mantención de Calderas y Sistemas de Calefacción',
          'Operación de Centrales Térmicas',
          'Revisión y Mantención de Sistemas de Presurización',
          'Mantención de Redes de Agua',
          'Mantención de Sistemas de Extracción de Aire',
