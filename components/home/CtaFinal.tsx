      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <Reveal className="text-center">
          <div className="inline-flex items-center gap-3 mb-6">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.25em] text-neb-black/70">Cotización gratis</span>
            <span className="w-10 h-px bg-neb-black/50" />
          </div>
          <h2
          ...
          <p className="text-neb-black/75 text-lg lg:text-xl mb-12 max-w-2xl mx-auto leading-relaxed">
            Visitamos, diagnosticamos y te entregamos una propuesta con costos y plazos certeros. Sin compromiso.
          </p>
